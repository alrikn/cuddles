...
static double print_min_max_int(int *data, int array_len,
...
static int print_values_int(int *data, int array_len)
{
    double min = 0.0;
    double max = 0.0;
...
{
    int *array = malloc(sizeof(int) * frame->nb_rows);
    int tracker = 0;
    void *value = NULL;
